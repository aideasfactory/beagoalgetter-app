  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* Social Connections */}
        <div>
          <h3 className="text-white mb-4">Social Connections</h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/40">
                      {userProfile.socialConnections.instagram ? 'Connected' : 'Not connected'}
                    </div>
                  </div>
                </div>
                <Button
                  variant={userProfile.socialConnections.instagram ? 'outline' : 'default'}
                  size="sm"
                  className={userProfile.socialConnections.instagram ? 'border-white/10 bg-white/5 text-white hover:bg-white/10' : 'text-black'}
                  style={!userProfile.socialConnections.instagram ? { backgroundColor: '#00c2ff' } : {}}
                  onMouseEnter={(e) => {
                    if (!userProfile.socialConnections.instagram) e.currentTarget.style.backgroundColor = '#00a8e0';
                  }}
                  onMouseLeave={(e) => {
                    if (!userProfile.socialConnections.instagram) e.currentTarget.style.backgroundColor = '#00c2ff';
                  }}
                >
                  {userProfile.socialConnections.instagram ? 'Disconnect' : 'Connect'}
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border border-white/10 bg-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/40">
                      {userProfile.socialConnections.twitter ? 'Connected' : 'Not connected'}
                    </div>
                  </div>
                </div>
                <Button
                  variant={userProfile.socialConnections.twitter ? 'outline' : 'default'}
                  size="sm"
                  className={userProfile.socialConnections.twitter ? 'border-white/10 bg-white/5 text-white hover:bg-white/10' : 'text-black'}
                  style={!userProfile.socialConnections.twitter ? { backgroundColor: '#00c2ff' } : {}}
                  onMouseEnter={(e) => {
                    if (!userProfile.socialConnections.twitter) e.currentTarget.style.backgroundColor = '#00a8e0';
                  }}
                  onMouseLeave={(e) => {
                    if (!userProfile.socialConnections.twitter) e.currentTarget.style.backgroundColor = '#00c2ff';
                  }}
                >
                  {userProfile.socialConnections.twitter ? 'Disconnect' : 'Connect'}
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border border-white/10 bg-white/5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-white/40">
                      {userProfile.socialConnections.facebook ? 'Connected' : 'Not connected'}
                    </div>
                  </div>
                </div>
                <Button
                  variant={userProfile.socialConnections.facebook ? 'outline' : 'default'}
                  size="sm"
                  className={userProfile.socialConnections.facebook ? 'border-white/10 bg-white/5 text-white hover:bg-white/10' : 'text-black'}
                  style={!userProfile.socialConnections.facebook ? { backgroundColor: '#00c2ff' } : {}}
                  onMouseEnter={(e) => {
                    if (!userProfile.socialConnections.facebook) e.currentTarget.style.backgroundColor = '#00a8e0';
                  }}
                  onMouseLeave={(e) => {
                    if (!userProfile.socialConnections.facebook) e.currentTarget.style.backgroundColor = '#00c2ff';
                  }}
                >
                  {userProfile.socialConnections.facebook ? 'Disconnect' : 'Connect'}
                </Button>
              </div>
            </div>
          </Card>
